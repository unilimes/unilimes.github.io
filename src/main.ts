...
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('kopa_webgl')) {
        ...
        document.getElementById('webgl_reserve_now').addEventListener('click', () => {
            ...
            setTimeout(function() { document.getElementById('yui_3_17_2_4_1509719218279_369').click(); }, 1000);
            setTimeout(function() { document.getElementById('yui_3_17_2_6_1509719314638_370').click(); }, 1500);
