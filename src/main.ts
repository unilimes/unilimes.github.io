...
document.addEventListener('DOMContentLoaded', () => {
    if (document.getElementById('kopa_webgl')) {
        ...
        document.getElementById('webgl_reserve_now').addEventListener('click', () => {
            ...
            setTimeout(addToCart, 900, 'yui_3_17_2_1_1509984706599_152', "[data-item-id='59f716b424a694055a7c20c0'", window['kopa_tally'].arm);
            setTimeout(addToCart, 1100, 'yui_3_17_2_1_1509985286676_152', "[data-item-id='59fc7b5f24a694eecd2344c2'", window['kopa_tally'].cushion);
