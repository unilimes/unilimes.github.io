    ...
    if (document.getElementById('kopa_webgl')) {
        ...
        document.getElementById('webgl_reserve_now').addEventListener('click', () => {
            ...
            if( window['kopa_tally'].arm > 0 ){
                setTimeout(addToCart, 800, 'yui_3_17_2_1_1509984998759_152', "[data-item-id='59fc7b58652deac953923e02'", window['kopa_tally'].arm);
            }
            if( window['kopa_tally'].back > 0 ){
                setTimeout(addToCart, 1100, 'yui_3_17_2_1_1509985394439_153', "[data-item-id='59fc7b18ec212dd8d9a3661a'", window['kopa_tally'].back);
            }
            if( window['kopa_tally'].sofa > 0 ){
                setTimeout(addToCart, 1400, 'yui_3_17_2_1_1509984706599_152', "[data-item-id='59f716b424a694055a7c20c0'", window['kopa_tally'].sofa);
            }
